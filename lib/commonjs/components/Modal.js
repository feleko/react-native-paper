...
class Modal extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "showModal", () => {
      ...
      if ((_this$subscription = this.subscription) !== null && _this$subscription !== void 0 && _this$subscription.remove) {
        this.subscription.remove();
      } else {
        _reactNative.BackHandler.removeEventListener('hardwareBackPress', this.handleBack);
      }

      this.subscription = _reactNative.BackHandler.addEventListener('hardwareBackPress', this.handleBack);
      const {
        opacity
      } = this.state;
      const {
    ...
    _defineProperty(this, "hideModal", () => {
      ...
      if ((_this$subscription2 = this.subscription) !== null && _this$subscription2 !== void 0 && _this$subscription2.remove) {
        var _this$subscription3;

        (_this$subscription3 = this.subscription) === null || _this$subscription3 === void 0 ? void 0 : _this$subscription3.remove();
      } else {
        _reactNative.BackHandler.removeEventListener('hardwareBackPress', this.handleBack);
      }
  ...
  componentWillUnmount() {
    ...
    if ((_this$subscription4 = this.subscription) !== null && _this$subscription4 !== void 0 && _this$subscription4.remove) {
      this.subscription.remove();
    } else {
      _reactNative.BackHandler.removeEventListener('hardwareBackPress', this.handleBack);
    }
